...
# ─────────────────────────────────────────────────────────────
log "Testing hijack success rate WITH and WITHOUT mitigation"
log ""
...
log ""
log "${CYAN}Testing $ATTEMPTS attempts WITH mitigation applied...${RESET}"
apply_mitigation
sleep 5
...
log "│ Hijack success (with ROV):      ${RATE_WITH_MIT}%                    │"
